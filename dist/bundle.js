...
/***/ function(module, exports, __webpack_require__) {
	...
	var metrics = __webpack_require__(100);
	...
	function getMetrics(c, fontSize) {
	    ...
	    try {
	        for (var _iterator = Object.entries(metrics[c.charCodeAt(0)])[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
